            ...
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-10 text-center">
                        <img src="img/brand/fibos.team.png"  class="img-fluid" style="padding-bottom: 10rem;">
                        <p class="lead text-white mt-4 mb-5">A beautiful Design System for Bootstrap 4. </p>
