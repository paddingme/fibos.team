...
<!--
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <base-dropdown tag="li" class="nav-item">
                    ...
                    <router-link to="/landing" class="dropdown-item">BP 福布斯</router-link>
                    <router-link to="/login" class="dropdown-item">节点排名</router-link>
                    <router-link to="/profile" class="dropdown-item">投票统计</router-link>
                </base-dropdown>
                <li class="nav-item">
            ...
            <!-- <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <base-dropdown tag="li" class="nav-item">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        <i class="ni ni-collection d-lg-none"></i>
                        <span class="nav-link-inner--text">节点检测</span>
                    </a>
                    <router-link to="/landing" class="dropdown-item">Landing</router-link>
                    <router-link to="/profile" class="dropdown-item">Profile</router-link>
                    <router-link to="/login" class="dropdown-item">Login</router-link>
